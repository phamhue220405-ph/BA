...
function seedData() {
  ...
  // Posts
  const posts = [
    { id: 'post1', title: 'Bộ sưu tập áo dài mùa cưới 2025', content: '<p>Chào mừng bạn đến với bộ sưu tập áo dài cưới mới nhất của chúng tôi. Với hơn 50 mẫu áo dài được thiết kế tinh tế, chúng tôi tự hào mang đến cho bạn những lựa chọn hoàn hảo cho ngày trọng đại.</p><p>Đặt lịch thử ngay hôm nay để nhận ưu đãi đặc biệt!</p>', images: ['https://images.unsplash.com/photo-1594938298603-c8148c4b4e5b?w=600'], categoryId: 'news', tags: ['áo dài', 'cưới'], isPublished: true, createdBy: 'u_marketing', createdAt: new Date(Date.now() - 2 * 86400000).toISOString() },
    { id: 'post2', title: 'Khuyến mãi thuê váy cưới tháng 6', content: '<p>Nhân dịp mùa cưới tháng 6, chúng tôi giảm giá 15% cho tất cả các đơn thuê váy cưới. Sử dụng mã <strong>WELCOME10</strong> khi thanh toán để nhận ưu đãi.</p>', images: ['https://images.unsplash.com/photo-1519741497674-611481863552?w=600'], categoryId: 'promotion', tags: ['khuyến mãi', 'váy cưới'], isPublished: true, createdBy: 'u_marketing', createdAt: new Date(Date.now() - 86400000).toISOString() },
  ];
